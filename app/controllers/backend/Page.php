...
class Page extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model(BACKEND.'Model_page');
	}
	...
	public function update()
	{
		...
		if (isset($_POST['form_impressum'])) {
			$form_data = array(
				'impressum_heading' => $_POST['impressum_heading'],
				'impressum_content' => $_POST['impressum_content'],
				'mt_impressum'      => $_POST['mt_impressum'],
				'mk_impressum'      => $_POST['mk_impressum'],
				'md_impressum'      => $_POST['md_impressum']
			);
		...
		if (isset($_POST['form_datenschutz'])) {
			$form_data = array(
				'datenschutz_heading' => $_POST['datenschutz_heading'],
				'datenschutz_content' => $_POST['datenschutz_content'],
				'mt_datenschutz'      => $_POST['mt_datenschutz'],
				'mk_datenschutz'      => $_POST['mk_datenschutz'],
				'md_datenschutz'      => $_POST['md_datenschutz']
			);
