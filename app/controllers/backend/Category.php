...
class Category extends CI_Controller 
{
	function __construct() 
	{
        ...
        $this->load->model(BACKEND.'Model_category');
    }
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    else
		    {
				...
				redirect(base_url('backend/category/add'));
		    }
            
        } else {            
            $this->load->view(BACKEND.'header',$data);
			$this->load->view(BACKEND.'category/category_add',$data);
			$this->load->view(BACKEND.'footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url('backend/category/edit'.$id));
		    }
           
		} else {
			$data['category'] = $this->Model_category->get_category($id);
	       	$this->load->view(BACKEND.'header',$data);
			$this->load->view(BACKEND.'category/category_edit',$data);
			$this->load->view(BACKEND.'footer');
		}
