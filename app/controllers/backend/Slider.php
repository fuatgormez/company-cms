...
class Slider extends CI_Controller 
{
	function __construct() 
	{
        ...
        $this->load->model(BACKEND.'Model_slider');
    }
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) {
	            ...
	            redirect(base_url(BACKEND.'slider'));
		    }
		    else {
            ...
            $this->load->view(BACKEND.'header',$data);
			$this->load->view(BACKEND.'slider/slider_add',$data);
			$this->load->view(BACKEND.'footer');
        }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
				...
				$this->session->set_flashdata('success',$success);
	            redirect(base_url(BACKEND.'slider/edit'.$id));
		    }
           
		} else {
			$data['slider'] = $this->Model_slider->getData($id);
	       	$this->load->view(BACKEND.'header',$data);
			$this->load->view(BACKEND.'slider/slider_edit',$data);
			$this->load->view(BACKEND.'footer');
		}
