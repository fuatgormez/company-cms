		...
		<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_loader" data-toggle="tab">Loader</a></li>
					...
					<div class="tab-content">
          				<div class="tab-pane active" id="tab_logo">
          					<?php echo form_open_multipart(base_url('backend/setting/update'),array('class' => 'form-horizontal')); ?>
                          ...
                          <div class="tab-pane" id="tab_loader">
          					<?php echo form_open_multipart(base_url('backend/setting/update'),array('class' => 'form-horizontal')); ?>
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">Existing Photo</label>
							            <div class="col-sm-6" style="padding-top:6px;">
							                <img src="<?php echo base_url('public/uploads/'.$setting['loader']); ?>" class="existing-photo" style="height:40px;">
							            </div>
							        </div>
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">New Photo</label>
							            <div class="col-sm-6" style="padding-top:6px;">
							                <input type="file" name="photo_loader">
							            </div>
							        </div>
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_loader">Update Loader</button>
										</div>
									</div>
								</div>
							</div>
          				...
          				<div class="tab-pane" id="tab_top_bar">
							<?php echo form_open(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_top_bar')); ?>
							<div class="box box-info">
								<div class="box-body">									
									<div class="form-group">
          				...
          				<div class="tab-pane" id="tab_footer">
							<?php echo form_open(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_footer_general')); ?>
							...
							<?php echo form_open_multipart(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_footer_newsletter')); ?>
							...
							<?php echo form_open_multipart(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_footer_cta')); ?>
          				...
          				<div class="tab-pane" id="tab_email">
          					<?php echo form_open(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_email')); ?>
							<div class="box box-info">
								<div class="box-body">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-bordered">                                
                                        <tr>
                                            <?php echo form_open_multipart(base_url('backend/setting/update'),array('class' => '')); ?>
                                            <td style="width:50%">
                                                <h4>About Page</h4>
                                                <p>
          				...
          				<div class="tab-pane" id="tab_sidebar">
          					<?php echo form_open(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_sidebar')); ?>
							<div class="box box-info">
								<div class="box-body">                                    
                        ...
                        <div class="tab-pane" id="tab_color">
                            <?php echo form_open(base_url('backend/setting/update'),array('class' => 'form-horizontal', 'name' => 'form_color')); ?>
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
