			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				<div class="tab-pane active" id="tab_1">						
						<?php echo form_open(base_url('backend/account/profile_update'),array('class' => 'form-horizontal', 'name' => 'form1')); ?>
						<div class="box box-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<button type="submit" class="btn btn-success pull-left ajax_request">Update Information</button>
									</div>
								</div>
							</div>
						</div>
      				...
      				<div class="tab-pane" id="tab_2">
						<?php echo form_open_multipart(base_url('backend/profile/update'),array('class' => 'form-horizontal')); ?>
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group">
						            ...
						            <div class="col-sm-6" style="padding-top:6px;">
						            	<?php if($this->session->userdata('photo') ==''): ?>
						            		<img src="<?php echo base_url(); ?>public/images/no-photo.jpg" class="existing-photo" alt="profile photo" width="140">
						            	<?php else: ?>
      				...
      				<div class="tab-pane" id="tab_3">
						<?php echo form_open(base_url('backend/profile/update'),array('class' => 'form-horizontal')); ?>
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group">
