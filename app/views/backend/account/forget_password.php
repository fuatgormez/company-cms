...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
		...
		<?php echo form_open(base_url('backend/account/forget-password'));?>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Email address" name="email" type="text" autocomplete="off" autofocus>
			</div>
			<div class="row">
				<div class="col-xs-8" style="padding-top:7px;"><a href="<?php echo base_url(); ?>backend/login" style="color:red;">back to login page</a></div>
				<div class="col-xs-4">
