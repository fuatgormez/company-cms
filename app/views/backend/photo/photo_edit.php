...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url('backend/photo'); ?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url('backend/photo/edit/'.$photo['photo_id']),array('class' => 'form-horizontal')); ?>
