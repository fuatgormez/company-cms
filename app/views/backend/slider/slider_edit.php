...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url('backend/slider'); ?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url('backend/slider/edit/'.$slider['id']), array('class' => 'form-horizontal'));?>
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Existing Photo</label>
							<div class="col-sm-9" style="padding-top:5px">
								<img src="<?php echo base_url('public/uploads/slider/'.$slider['photo']); ?>" alt="Slider Photo" style="width:400px;">
							</div>
						</div>
						<div class="form-group">
