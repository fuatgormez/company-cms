...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url('backend/portfolio/add'); ?>" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
							...
							foreach ($portfolio as $row) {
								...
								<tr>
									...
									<td>
										...
										<a href="<?php echo base_url('backend/portfolio/edit/'.$row['id']); ?>" class="btn btn-primary btn-xs">Edit</a>
										<a href="<?php echo base_url('backend/portfolio/delete/'.$row['id']); ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Delete</a>
									</td>
								</tr>
