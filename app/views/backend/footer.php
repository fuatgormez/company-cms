	...
	<script src="<?php echo base_url(); ?>public/backend/js/jquery-2.2.4.min.js"></script>
	...
	<script src="<?php echo base_url(); ?>public/backend/js/jscolor.js"></script>
	...
	<script src="<?php echo base_url(); ?>public/backend/js/jquery.fancybox.pack.js"></script>
	<script src="<?php echo base_url(); ?>public/backend/js/app.min.js"></script>
	<script src="<?php echo base_url(); ?>public/backend/js/summernote.js"></script>
	<script src="<?php echo base_url(); ?>public/backend/js/jquery.magnific-popup.min.js"></script>
	<script src="<?php echo base_url(); ?>public/backend/js/demo.js"></script>
	<script src="<?php echo base_url(); ?>public/backend/js/custom.js"></script>
