...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url('backend/why_choose'); ?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url('backend/why_choose/edit/'.$why_choose['id']),array('class' => 'form-horizontal'));?>
					...
					<div class="box-body">						
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px;">
								<img src="<?php echo base_url('public/uploads/why_choose/'.$why_choose['photo']); ?>" alt="Why Choose Us Photo" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
