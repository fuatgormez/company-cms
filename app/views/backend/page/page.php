                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home')); ?>
                            ...
                            <?php echo form_open_multipart(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_welcome')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open_multipart(base_url('backend/page/update'),array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                            ...
                            <?php echo form_open_multipart(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_why_choose')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open_multipart(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_feature')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_service')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_counter_text')); ?>
                                <div class="form-group">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_portfolio')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_booking')); ?>
                                <div class="form-group">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_team')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_pricing_table')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_testimonial')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                            ...
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_home_blog')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab_2">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_about')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_4">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_faq')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_5">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_service')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_7">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_testimonial')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_8">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_news')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_16">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_event')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_9">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_contact')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_10">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_search')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_11">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_term')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_12">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_privacy')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_14">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_team')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_15">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_portfolio')); ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab_17">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_impressum')); ?>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="impressum_content" class="form-control" cols="30" rows="10" id="editor4"><?php echo $page_impressum['impressum_content']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Meta Title </label>
                        ...
                        <div class="tab-pane" id="tab_18">
                            <?php echo form_open(base_url('backend/page/update'),array('class' => 'form-horizontal', 'name' => 'form_datenschutz')); ?>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="datenschutz_content" class="form-control" cols="30" rows="10" id="editor5"><?php echo $page_datenschutz['datenschutz_content']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Meta Title </label>
