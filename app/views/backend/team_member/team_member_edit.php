...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url('backend/team_member'); ?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url('backend/team_member/edit/'.$team_member['id']),array('class' => 'form-horizontal')); ?>
