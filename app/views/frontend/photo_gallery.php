<!--Banner Start-->
<div class="banner-slider" style="background-image: url(<?php echo base_url('public/uploads/'.$setting['banner_photo_gallery']); ?>)">
    <div class="bg"></div>
                        ...
                        <div class="gallery-photo" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $row['photo_name']; ?>)">
                            ...
                            <div class="gallery-table">
                                <div class="gallery-icon">
                                    <a href="<?php echo base_url('public/uploads/photo_gallery/'.$row['photo_name']); ?>" class="magnific"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
