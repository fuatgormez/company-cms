...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo base_url('public/uploads/'.$setting['favicon']); ?>">

    <!-- Stylesheets -->
    <link rel="stylesheet" href="<?php echo base_url('public/'.FRONTEND.'css/animate.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/'.FRONTEND.'css/bootstrap.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/'.FRONTEND.'css/jquery-ui.min.css'); ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/'.FRONTEND.'css/style.css?v=1.0'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/'.FRONTEND.'css/spacing.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/'.FRONTEND.'css/responsive.css?v=1.0'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/plugins/cookie/css/cookiebar.css?v=1.0'); ?>">

    <script type="text/javascript" src="//platform-api.sharethis.com/js/sharethis.js#property=5993ef01e2587a001253a261&product=inline-share-buttons"></script>

    <script data-ad-client="ca-pub-7747133413487257" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
