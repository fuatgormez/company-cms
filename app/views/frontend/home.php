...
<div class="slider">
    <div class="slide-carousel slider-one owl-carousel">
        <?php foreach ($sliders as $slider):?>
            <div class="slider-item flex" style="background-image:url(<?php echo base_url('public/uploads/slider/'.$slider['photo']); ?>);">
            ...
            <?php foreach ($photo_gallery as $row):?>
                <div class="col-lg-4">
                    <div class="choose-item flex">
                        <img class="lazyload" data-src="<?php echo base_url('public/uploads/photo/'.$row['photo_name']); ?>" width="765" height="574" />
<img class="lazyload" src="<?php echo base_url('public/uploads/photo/'.$row['photo_name']); ?>" data-src="<?php echo base_url('public/uploads/photo/'.$row['photo_name']); ?>" width="765" height="574" />
                    </div>
                </div>
            <?php endforeach;?>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($why_chooses as $why_choose): ?>
                <div class="col-lg-4">
                    <div class="choose-item flex" style="background-image: url(<?php echo base_url('public/uploads/why_choose/'.$why_choose['photo']); ?>)">
                        <div class="choose-icon">
                            <i class="<?php echo $why_choose['icon']; ?>" aria-hidden="true"></i>
                        </div>
                        <div class="choose-text">
                            <h4><?php echo $why_choose['name']; ?></h4>
                            <p>
                                <?php echo nl2br($why_choose['content']); ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <?php foreach ($services as $service): ?>
                <div class="col-lg-4 col-md-6">
                    <div class="services-item effect-item">
                        <a href="<?php echo base_url(); ?>service/view/<?php echo $service['id']; ?>" class="image-effect">
                            <div class="services-photo" style="background-image: url(<?php echo base_url('public/uploads/service/'.$service['photo']); ?>)"></div>
                        </a>
                        <div class="services-text">
                            <h3><a href="<?php echo base_url(); ?>service/view/<?php echo $service['id']; ?>"><?php echo $service['name']; ?></a></h3>
                            <p>
                                <?php echo nl2br($service['short_description']); ?>
                            </p>
                            <div class="button-bn">
                                <a href="<?php echo base_url(); ?>service/view/<?php echo $service['id']; ?>"><?php echo READ_MORE; ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="portfolio-menu">
                    <ul id="filtrnav">
                        ...
                        <?php foreach ($portfolio_category as $row):?>
                        ...
                        <div class="portfolio-photo" style="background-image: url(<?php echo base_url(); ?>public/uploads/portfolio/<?php echo $row['photo']; ?>)">
                            ...
                            <div class="portfolio-table">
                                <div class="portfolio-icon">
                                    <a href="<?php echo base_url('public/uploads/portfolio/'.$row['photo']); ?>" class="magnific"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="portfolio-text">
                            <h3><a href="<?php echo base_url('portfolio/view/'.$row['id']); ?>"><?php echo $row['name']; ?></a></h3>
                        </div>
                    </div>
                </div>
            <?php endforeach;?>
                    ...
                    foreach ($team_members as $row) {
                        ...
                        <div class="team-item">
                            <div class="team-photo">
                                <img src="<?php echo base_url(); ?>public/uploads/team_member/<?php echo $row['photo']; ?>" alt="Team Photo">
                            </div>
                            <div class="team-text">
...
<div class="testimonial-area pt_90 pb_90" style="background-image: url(<?php echo base_url('public/uploads/'.$page_home['home_testimonial_photo']); ?>)">
                    ...
                    <?php foreach ($testimonials as $row): ?>
                        <div class="testimonial-item">
                            <div class="testimonial-photo">
                                <img src="<?php echo base_url('public/uploads/testimonial/'.$row['photo']); ?>" alt="<?php echo $row['name'];?>">
                            </div>
                ...
                <div class="blog-carousel owl-carousel">                    
                    ...
                    foreach ($all_news_category as $news) {
                        ...
                        <div class="blog-item effect-item">
                            <a href="<?php echo base_url('news/view/'.$news['news_id']); ?>" class="image-effect">
                                <div class="blog-image" style="background-image: url(<?php echo base_url('public/uploads/news/'.$news['photo']); ?>)"></div>
                            </a>
                            <div class="blog-text">
                                <h3><a href="<?php echo base_url('news/view/'.$news['news_id']); ?>"><?php echo $news['news_title']; ?></a></h3>
                            ...
                            <div class="blog-author">
                                <ul>
                                    <li><a href="<?php echo base_url('category/'.$news['category_id']); ?>"><i class="fa fa-pencil-square-o"></i><?php echo $news['category_name']; ?></a></li>
                                    <li class="blog-button"><a href="<?php echo base_url('news/view/'.$news['news_id']); ?>"><i class="fas fa-long-arrow-alt-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php } ?>
            ...
            <div class="col-12">
                <div class="brand-carousel owl-carousel">
                    <?php foreach($clients as $row):?>
                        ...
                        <?php else: ?>
                            <div class="brand-item"><img src="<?php echo base_url('public/uploads/client/'.$row['photo']); ?>" alt="<?php echo $row['name']; ?>"></div>
                        <?php endif; ?>
                    <?php endforeach;?>
                </div>
            </div>
